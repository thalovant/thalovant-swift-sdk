...
final class WireProtocolTests: XCTestCase {
    func testAuthorizationIsBase64UserAgentColonAccessKey() {
        let token = HiveWire.authorization(userAgent: "ThalovantSwiftSDK/0.1.1", accessKey: "access-1")
        XCTAssertEqual(token, Data("ThalovantSwiftSDK/0.1.1:access-1".utf8).base64EncodedString())
    }
...
final class AskCorrelationTests: XCTestCase {
    ...
    func testTransportEndpointURLCarriesAuthorization() throws {
        ...
        let transport = HiveMindWSSTransport(identity: identity, userAgent: "ThalovantSwiftSDK/0.1.1")
        ...
        XCTAssertEqual(value, Data("ThalovantSwiftSDK/0.1.1:access-1".utf8).base64EncodedString())
    }
}
